import './App.css';
import { useGetAllPostQuery, useGetPostByIdQuery, useGetPostByLimitQuery, useDeletePostMutation, useCreatePostMutation, useUpdatePostMutation } from './services/apiServices';
...
function App() {
  ...
  return (
    // Get All Data
    <div className="App">
      <h1 style={{color:"#d00000"}}>Redux Toolkit Example  - RTK Query (Get All Data)</h1>
      {
        responseInfo.data.map((post, i) =>
          <div key={i}>
            <h2 style={{color:"green"}}>{post.id} {post.title}</h2>
            <p>{post.body}</p>
            <hr />
          </div>
        )
    ...
    // Get Single Data
    // <div className="App">
    //   <h1 style={{color:"#d00000"}}>Redux Toolkit Example  - RTK Query (Get Single Data)</h1>
    ...
    // Get Limited Data
    // <div className="App">
    //   <h1 style={{color:"#d00000"}}>Redux Toolkit Example  - RTK Query (Get Limited  Data)</h1>
    //   {
    //     responseInfo.data.map((post, i) =>
    //       <div key={i}>
    ...
    // Delete Data
    // <div className="App">
    //   <h1 style={{color:"#d00000"}}>Redux Toolkit Example  - RTK Query (Delete Data)</h1>
    //   <button onClick={() => { deletePost(2) }}>Delete Post</button>
    // </div>

    // Create Data
    // <div className="App">
    //   <h1 style={{color:"#d00000"}}>Redux Toolkit Example  - RTK Query (Create Data)</h1>
    //   <button onClick={() => { createPost(newPost) }}>Add Post</button>
    // </div>

    // Update Data
    // <div className="App">
    //   <h1 style={{color:"#d00000"}}>Redux Toolkit Example  - RTK Query (Update Data)</h1>
